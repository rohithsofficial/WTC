const CoffeeData = [
  {
    ...
    imagelink_square: require('../assets/icon.png'),
    imagelink_portrait: require('../assets/icon.png'),
    ingredients: 'Milk',
