  ...
  const renderSettingItem = (
    ...
    <View style={styles.settingItem}>
      <View style={styles.settingIcon}>
        <MaterialIcons name={icon} size={24} color={COLORS.primaryOrangeHex} />
      </View>
      ...
      <Switch
        ...
        trackColor={{
          false: COLORS.primaryGreyHex + "40",
          true: COLORS.primaryOrangeHex + "40",
        }}
        thumbColor={
          settings[key] ? COLORS.primaryOrangeHex : COLORS.primaryGreyHex
        }
        disabled={saving}
      />
    </View>
